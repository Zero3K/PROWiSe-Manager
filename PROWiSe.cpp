...
#define THIS_VERSION_PROGSETTS_COMPATABILITY_SIGN 0x0180//��� ����������� ������������� �������� ���������� ������ ;  last=0x1022
#define THIS_VERSION_PROGSETTS_VERSION 0x0180//��� ������������� ������
...
end_load_setts:
 ...
 tbuf3=(char*)dwp; dwp+=300;//������ �� ������������
 t1buf4=(char*)dwp; dwp+=300;//Windows,Performance
 t2buf4=(char*)dwp; dwp+=300;//About
 //hwndsStart=(DWORD*)n; n+=4000; hwndsEnd=n;//HWNDs ��� Windows_tab = 1000 DWORDs
 ...
 tbuf_gfvdi=(char*)dwp; dwp+=512;//��� GetFileVerDescInfo
